// spelltiers.js — rarity tiers + weighted tome draw. Every spell maps to a tier
...
const TIER_WEIGHT = { common: 100, uncommon: 45, rare: 12, legendary: 4, hybrid: 0 };
const TIER_COLOR  = { common: '#c9c9d6', uncommon: '#7bd88f', rare: '#4ecdff', legendary: '#ffd166', hybrid: '#ff4df0' };
const TIER_RANK   = { common: 0, uncommon: 1, rare: 2, legendary: 3, hybrid: 4 };
...
function tierColor(id) { return TIER_COLOR[spellTier(id)]; }
